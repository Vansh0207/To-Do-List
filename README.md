...
│   ├── controllers/
│   │   ├── itemController.js   # Logic for To-Do item CRUD operations
│   │   └── userController.js   # Logic for user registration and login
│   ├── middleware/
│   │   ├── authMiddleware.js   # JWT authentication middleware
│   │   └── errorMiddleware.js  # Global error handling middleware
│   ├── models/
│   │   ├── Item.js             # Mongoose schema for To-Do items
│   │   └── User.js             # Mongoose schema for users
│   ├── routes/
│   │   ├── itemRoutes.js       # API routes for To-Do items
...
├── frontend/
│   ├── CRUD.html               # Main frontend HTML structure
│   ├── CRUD.js                 # Frontend JavaScript logic and API calls
